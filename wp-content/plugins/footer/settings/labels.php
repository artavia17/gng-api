<?php 
    // Config plugins
    $labels = array(
        'name' => _x('All Footer', 'Post type general name', 'textdomain'),
        'singular_name' => _x('Footer Settings', 'Post type singular name', 'textdomain'),
        'menu_name' => _x('Footer Settings', 'Admin Menu text', 'textdomain'),
        ...
        'archives' => _x('Footer Footer archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'textdomain'),
        ...
        'items_list_navigation' => _x('Footer Footer list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'textdomain'),
        'items_list' => _x('Footer Footer list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'textdomain'),
    );