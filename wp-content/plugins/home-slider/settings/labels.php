<?php 
    // Config plugins
    $labels = array(
        'name' => _x('All slider', 'Post type general name', 'textdomain'),
        'singular_name' => _x('Sliders', 'Post type singular name', 'textdomain'),
        'menu_name' => _x('Home Sliders', 'Admin Menu text', 'textdomain'),
        'name_admin_bar' => _x('Home Sliders', 'Add New on Toolbar', 'textdomain'),
        ...
        'view_item' => __('View Sliders', 'textdomain'),
        ...
        'archives' => _x('Home slider archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'textdomain'),
        'insert_into_item' => _x('Insert into sliders', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'textdomain'),
        ...
        'items_list_navigation' => _x('Home slider list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'textdomain'),
        'items_list' => _x('Home slider list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'textdomain'),
    );